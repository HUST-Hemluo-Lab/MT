...
if __name__ == "__main__":
    ...
    smi_vocab_path = 'data/psmi_vocab1.pkl'
    inchi_vocab_path = 'data/inchi_vocab1.pkl'
    pubchemfp_vocad_path = 'data/ppubfp_vocab1.pkl'
    smi_pharm_inchi_pubchemfp_filepath = 'data/smi_pharm_inchi_pubchem_corpus2.txt'
    try:
        train_smi(smi_vocab_path=smi_vocab_path,
                ...
                size=500,       #Small size for demo testing
                seq_len=256,n_heads=4,n_hidden=256,batch_size=8,n_layers=2)
