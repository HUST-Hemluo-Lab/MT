...
class TorchVocab(object):
    ...
    def __init__(self, counter, max_size=None, min_freq=1, specials=['<pad>', '<oov>'],
        ...
        # If the frequency is less than min_freq don't add to the vocab
...
class WordVocab(Vocab):
    ...
    def to_seq(self, sentence, seq_len=512, with_eos=False, with_sos=False, with_len=False):
...
def built_vocab(corpus_path,out_path):
    min_freq = 1
    vocab_size = None
...
#example:
def main():  
    corpus_path = 'data/smi_corpus.txt'
    out_path = 'data/smi_vocab.pkl'
    min_freq = 1
    vocab_size = None
